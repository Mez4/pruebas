        ...
        Componente: (cprops: any) => (
            <div>
                <div>
                    ...
                    <div className={"row"}>
                        <div className={"col-sm-12 col-md-6"}>
                            <CustomFieldText2 disabled={cprops.Cargando} label={'Tel.Movil'} datoType='string' name={`${Prefijo}TelefonoMovil`} placeholder={'Telefono movil'} />
                        </div>
                        <div className={"col-sm-12 col-md-6"}>
                ...
                <div>
                    ...
                    <div className={"row"}>
                        <div className={"col-sm-12 col-md-6"}>
                            <ViviendasTipo {...cprops} label={'ViviendaTipo'} name={`${Prefijo}viviendaTipoId`} />
                        </div>
                        <div className={"col-sm-12 col-md-6"}>
                    ...
                    <div className={"row"}>
                        <div className={"col-sm-12 col-md-6"}>
                            <VialidadesTipo {...cprops} label={'VialidadTipo'} name={`${Prefijo}vialidadTipoId`} placeholder={'vialidadTipoId'} />
                        </div>
                        <div className={"col-sm-12 col-md-6"}>
                            <CustomFieldText2 {...cprops} label={'Número Exterior'} name={`${Prefijo}NumeroExterior`} placeholder={'Numero Exterior'} />
                        </div>
                    </div>

                    <div className={"row"}>
                        <div className={"col-sm-12 col-md-6"}>
                            <OrientacionVialidadesTipo {...cprops} label={'Orientacion'} name={`${Prefijo}orientacionVialidadTipoId`} placeholder={'orientacionVialidadTipoId'} />
                        </div>
                        <div className={"col-sm-12 col-md-6"}>
                            {/* <div className={"col-sm-12 col-md-6"}> */}
                            <CustomFieldText2 {...cprops} label={'Número Interior'} name={`${Prefijo}NumeroInterior`} placeholder={'Número Interior (Opcional)'} />
                            {/* </div> */}
