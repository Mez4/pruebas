...
export const FormaDatosGeneralesLaboral = ({ Prefijo, Titulo, SubTitulo, /*TieneEmpleo, OcupacionID, AsentID*/ }: DireccionTipo) => {
    ...
    if (TrabajaDisplay === 'block') {
        ...
        ValSchemaObjecet[`${Prefijo}CalleLaboral`] = Yup.string().required()
    ...
    return {
        ...
        Componente: (cprops: any) => (
            <div>
                <CustomSelect2 name={`${Prefijo}Trabaja`} disabled={false} options={[{ value: true, label: 'Si, tiene empleo.' }, { value: false, label: 'No, no tiene empleo.' }]} addDefault={false} label={'¿Trabaja?'} placeholder={'¿El Aval tiene empleo actualmente?'} accion={TrabajaSelected} valor={trabaja} />
                <div style={{ display: TrabajaDisplay }}>
                    ...
                    {/* <div className={"row"}>
                        <div className={"col-sm-12 col-md-6"}>
                            <CustomFieldText2 {...cprops} label={'Calle'} name={`${Prefijo}CalleLaboral`} placeholder={'Calle'} />
                        </div>
                        <div className={"col-sm-12 col-md-6"}>
                    ...
                    <div className={"row"}>
                        <div className={"col-sm-12 col-md-6"}>
                            <ViviendasTipo {...cprops} label={'vivienda Tipo'} name={`${Prefijo}viviendaTipoIdLaboral`} />
                        </div>
                        <div className={"col-sm-12 col-md-6"}>
                    ...
                    <div className={"row"}>
                        <div className={"col-sm-12 col-md-6"}>
                            <VialidadesTipo {...cprops} label={'vialidad Tipo'} name={`${Prefijo}vialidadTipoIdLaboral`} placeholder={'vialidadTipoId'} />
                        </div>
                        <div className={"col-sm-12 col-md-6"}>
                    ...
                    <div className={"row"}>
                        <div className={"col-sm-12 col-md-6"}>
                            <OrientacionVialidadesTipo {...cprops} label={'orientacion'} name={`${Prefijo}orientacionVialidadTipoIdLaboral`} placeholder={'orientacionVialidadTipoId'} />
                        </div>
                        <div className={"col-sm-12 col-md-6"}>
                            {/* <div className={"col-sm-12 col-md-6"}> */}
                            <CustomFieldText2 {...cprops} label={'Número Interior'} datoType='text' name={`${Prefijo}NumeroInteriorLaboral`} placeholder={'Numero Interior'} />
                            {/* </div> */}
                ...
                <ModalWin zIndex={4000} open={showAsentamiento}>
                    <ModalWin.Header>
