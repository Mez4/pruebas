...
export const FormaDatosPersonales = ({ Prefijo, Titulo, SubTitulo }: DireccionTipo) => {
    ...
    return {
        ...
        Componente: (cprops: any) => (
            <div>
                <div>
                    <CustomFieldText2 disabled={cprops.Cargando} datoType='text' label={'CURP'} name={`${Prefijo}CURP`} placeholder={'CURP'} />
                    <CustomFieldText2 disabled={cprops.Cargando} datoType='text' label={'RFC'} name={`${Prefijo}RFC`} placeholder={'RFC'} />
                    ...
                    <div style={{ display: conyugeDisplay }}>
                        ...
                        <CustomFieldText2 {...cprops.Cargando} datoType='text' label={'Nombre'} name={`${Prefijo}NombreConyuge`} placeholder={'Nombre de conyuge'} />
                    </div>
