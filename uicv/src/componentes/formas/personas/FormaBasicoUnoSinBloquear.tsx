...
export const FormaBasicoUnoSinBloquear = () => {
    ...
    return {
        ...
        Componente: (cprops: any) => (
            <div>
                <CustomFieldText2 {...cprops} disabled={false} label={'Nombre'} name={'Nombre'} placeholder={'Nombre(s)'} />
                <CustomFieldText2 {...cprops} disabled={false} label={'A.Paterno'} name={'ApellidoPaterno'} placeholder={'Apellido Paterno'} />
                <CustomFieldText2 {...cprops} disabled={false} label={'A.Materno'} name={'ApellidoMaterno'} placeholder={'Apellido Materno'} />
                <CustomFieldDatePicker2 {...cprops} disabled={false} label={'F.Nacimiento'} name={'FechaNacimiento'} placeholder={'Fecha Nacimiento'} />
