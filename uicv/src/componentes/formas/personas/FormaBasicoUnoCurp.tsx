...
export const FormaBasicoUnoCurp = (props: FormaAgregarTipo) => {
    ...
    return {
        ...
        Componente: (cprops: any) => (
            <div>
                <CustomFieldText2 {...cprops} disabled={props.statusCurp} label={'Nombre'} name={'Nombre'} placeholder={'Nombre(s)'} />
                <CustomFieldText2 {...cprops} disabled={props.statusCurp} label={'A.Paterno'} name={'ApellidoPaterno'} placeholder={'Apellido Paterno'} />
                <CustomFieldText2 {...cprops} disabled={props.statusCurp} label={'A.Materno'} name={'ApellidoMaterno'} placeholder={'Apellido Materno'} />
                <CustomFieldDatePicker2 {...cprops} disabled={props.statusCurp} label={'F.Nacimiento'} name={'FechaNacimiento'} placeholder={'Fecha Nacimiento'} />
