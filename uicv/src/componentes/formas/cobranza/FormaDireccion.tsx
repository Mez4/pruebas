...
export const FormaDireccion = ({ Prefijo, Titulo, SubTitulo }: DireccionTipo) => {
    ...
    InitialValues[`${Prefijo}Nota`] = ''
    InitialValues[`${Prefijo}ReferenciasGeograficas`] = ''
    ...
    ValSchemaObjecet[`${Prefijo}Nota`] = Yup.string().required()
    ValSchemaObjecet[`${Prefijo}ReferenciasGeograficas`] = Yup.string().required()
    ...
    return {
        ...
        Componente: (cprops: any) => (
            <div>
                ...
                {/* <div className={"row"}>
                        <div className={"col-sm-12 col-md-6"}>
                            <CustomFieldText2 disabled={cprops.Cargando} label={'Tel.Movil'} name={`${Prefijo}Telefeno`} placeholder={'Telefono movil'} />
                        </div>
                        <div className={"col-sm-12 col-md-6"}>
                ...
                <div>
                    ...
                    <div className={"row"}>
                        ...
                        <div className={"col-sm-12 col-md-6"}>
                            <CustomFieldText2 {...cprops} label={'Referencia'} datoType='text' name={`${Prefijo}ReferenciasGeograficas`} placeholder={'ReferenciasGeograficas'} />
                        </div>
                        <div className={"col-sm-12 col-md-6"}>
                            <CustomFieldText2 {...cprops} label={'Nota'} datoType='text' name={`${Prefijo}Nota`} placeholder={'Nota'} />
                        </div>
                    </div>
                </div>
