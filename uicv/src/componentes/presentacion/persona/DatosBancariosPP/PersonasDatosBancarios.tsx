...
import * as FnBanco from "../../../app/modulos/bancos/CompBancos/BancoBanco/Funciones";
import * as FnVariables from "../../../app/modulos/catalogos/CompCatalogos/CatalogoVariableGlobal/Funciones";
        ...
        <Card.Body.Content>
          ...
          <div>
            ...
            <CForm
              ...
              SMS={state.SMS}
              Listo={props.Listo}
              fnToggleListo={props.fnToggleListo}
