    ...
    return (
        <Formik
            ...
            validationSchema={Yup.object().shape({
                ...
                tarjeta: Yup.number().required("Campo requerido").test(
                    'len',
            ...
            <Form>
                ...
                {!loading &&
                    <div className="text-end">
                        <button type="reset" className="btn btn-danger waves-effect waves-light" disabled={CuentaAct || deshabilitar} onClick={fnCancelar}>
                            Limpiar
                        </button>
