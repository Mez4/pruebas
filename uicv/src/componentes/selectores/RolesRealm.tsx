...
class RolesRealm extends React.Component<RolesTipo, EstadoTipo> {
    ...
    componentDidMount() {
        if (this.props.cargar)
            axios.post(`${GetServerUrl()}sistema/usuarios/obtenerGruposRealm`, {}, {
    ...
    render() {
        ...
        // Opciones
        let opciones = this.state.Datos.map(e => ({ value: e.ID, label: e.NAME }))
