...
const EstatusDispersion = (props: EstatusDistribuidorTipo) => {
    ...
    const FNGetLocal = () => {
        ...
        axios.post(`${GetServerUrl()}SOMA/DispersionConsulta/EstatusDispersiones`, { Id: 0 }, {
            headers: {
...
export default connect(mapStateToProps, mapDispatchToProps)(EstatusDispersion)