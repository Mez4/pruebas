...
const SolicitudesAclaraciones = (props: CatalogosType) => {
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="input-group mb-9">
                                                        ...
                                                        ><FaPlus /></button>*/}
                                                        <button className="btn btn-outline-secondary" type="button" ><FiRefreshCcw /></button>
                                                    </div>
                                                </div>
                                            </div>
                                        }
...
export default connect(mapStateToProps, mapDispatchToProps)(SolicitudesAclaraciones)