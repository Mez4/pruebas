...
export const FromaReferenciaAval = (props: FromaReferenciaAvalTipo) => {
    ...
    React.useEffect(() => {
        setState(s => ({ ...s, DatosMostrar: FiltrarDatos(s.Datos, Columns, state.Filtro) }))
            ...
            {
                FNGetLocal(props.Item.SolicitudMesaCreditoID,1,3)
            }
            ...
            <ModalWin.Body>
                <Formik
                    ...
                    onSubmit={(values) => {
                        ...
                        let valuesPost: any = { SolicitudMesaCreditoID: props.Item.SolicitudMesaCreditoID, Tipo :2,TipoPersonaid: 3 }
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="input-group mb-3">
                                                        <input type="text" className="form-control" placeholder="Buscar Referencia Aval" value={state.Filtro} onChange={e => setState(s => ({ ...s, Filtro: e.target.value }))} />
                                                        <span className="input-group-text"><FaSearch /> </span>
                                                    
                                                        <button className="btn btn-outline-secondary" type="button" onClick={() => FNGetLocal(props.Item.SolicitudMesaCreditoID,1,3)}><FiRefreshCcw /></button>
                                                    </div>
                                                </div>
                                            </div>
                                        }
