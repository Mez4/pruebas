...
export const AgregarConPersonaEncargado = (props: FormaAgregarTipo) => {
        ...
        <ModalWin open={props.mostrar} large>
            ...
            <ModalWin.Body>
                <AsistenteFormik
                    MostrarPasos={true}
                    Pasos={[
                        FormasGestor.FormaDatosGenerales({ Prefijo: 'PersonaGestor_', Titulo: 'Encargado', SubTitulo: 'Encargado Persona' }),
                        FormasGestor.FormaDatosPersonales({ Prefijo: 'DatosPersonales_', Titulo: 'Encargado', SubTitulo: 'Datos Personales' }),
                    ]}
                    ...
                    PROMESA__PROCESAR={(Datos: any) => {
                        ...
                        return Funciones.FNAgregarPersonaEncargado(props.oidc, { ...Persona })
                            .then((respuesta: any) => {
                                setLoading(false)
