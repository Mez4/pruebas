...
export const ConfirmacionSMS = (props: CFormConfirmarType) => {
    // Loading
    ...
    const FNSMS = () => {
        ...
        Funciones.Envio_SMS(props.oidc, props.DistribuidorID, props.TicketID, props.Abono)
            .then((respuesta: any) => {
                setLoading(false)
                props.fnCancelar()
        ...
        <ModalWin open={props.Confirmacion} center >
            ...
            <ModalWin.Body>
                <div style={{ padding: '1em' }}>
                    <span >¿Esta Seguro(a) de Enviar el mensaje SMS de cancelacion para el TicketID {props.TicketID}? Con Abono de ${props.Abono}? </span><br /><br />
                ...
                <div className="text-end">
                    ...
                    {!state.Cargando &&  */}
                    <button type="button" className="ms-2 btn btn-success waves-effect waves-light" onClick={() => { FNSMS() }} >Aceptar</button>
                    {/* } */}
                </div>
            </ModalWin.Body>
        </ModalWin>
