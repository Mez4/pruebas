...
import * as Funciones from './Vales/Funciones'
...
const Vales = (props: CatalogosType) => {
        ...
        let colRet: IDataTableColumn[] =
            [
                ...
                {   name: 'Cancelar',
                    sortable: false,
                    cell: (props) =>
                        (props.Estatus === 'A' ) && <><button data-tip data-for={`btnCV_${props.Folio}`} style={{width: '100%', textAlign: 'center'}} className="btn btn-outline-default" type={"button"} onClick={() => {
                            setState(s => ({
                                ...s,
                                Form: {
                                    ...state.Form, Mostrar: true,
                                    Datos: { ValeraID: props.ValeraID, Folio: props.Folio, Estatus: props.Estatus },
                                    Id: props.ValeraID
                                }
                            }))
                        }}>
                        ...
                        <ReactTooltip id={`btnCV_${props.Folio}`} type="info"effect="solid">
                            CANCELAR VALE CON FOLIO {props.Folio}
                        </ReactTooltip></>
                },
            ]
        return colRet
...
export default connect(mapStateToProps, mapDispatchToProps)(Vales);