...
export const FNGet = (oidc: IOidc, Id?: number) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.post(`${GetServerUrl()}Prospeccion/TipoVivienda/get`, {}, {
            headers: {
...
export const FNAdd = (oidc: IOidc, Datos: { Descripcion: string , Activo: boolean}) =>
    new Promise((Resolver: any, Denegar: any) => {
        ...
        axios.post(`${GetServerUrl()}Prospeccion/TipoVivienda/add`, Datos, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
...
export const FNUpdate = (oidc: IOidc, Datos: { Descripcion: string , Activo: boolean }) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.post(`${GetServerUrl()}Prospeccion/TipoVivienda/update`, Datos, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
