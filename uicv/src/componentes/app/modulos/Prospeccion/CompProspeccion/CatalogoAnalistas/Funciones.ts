 ...
 */
 ...
 new Promise((Resolver: any, Denegar: any) => {
     axios.post(`${GetServerUrl()}Prospeccion/MesaCredito/getAnalistas`, {}, {
         headers: {
...
/***************************************************************/
    export const FnGetPersonas = (oidc: IOidc, PersonaID?: number) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.post(`${GetServerUrl()}Prospeccion/MesaCredito/getPersonas`, {"id": PersonaID}, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
 ...
 */
 ...
 new Promise((Resolver: any, Denegar: any) => {
     ...
     axios.post(`${GetServerUrl()}Prospeccion/MesaCredito/addAnalista`, Datos, {
         headers: {
             "Content-Type": "application/json",
             "Authorization": `Bearer ${oidc.user.access_token}`
         }
