...
export const AsignaAnalistaLlamadas = (props: CFormType) => {
            ...
            <ModalWin.Body>
                ...
                <Formik
                    ...
                    onSubmit={(values: any) => {
                        ...
                        setLoading(true)
                        Funciones.FNAsignaAnalistaLlamadas(props.oidc, { ...values, ProspectoID: props.Id, PersonaAnalistaID: values.PersonaAnalistaID })
                            .then((respuesta: any) => {
                                setLoading(false)
