...
type CFormType = {
    oidc: IOidc
    Id?: number,
    initialValues: { EmpresaExperienciaID: number, Descripcion: string, Activo: boolean },
    ...
    return (
        <Formik
            ...
            validationSchema={Yup.object().shape({
                Descripcion: Yup.string().required("Campo obligatorio").max(30, "Minimo 30 caracterer"),
