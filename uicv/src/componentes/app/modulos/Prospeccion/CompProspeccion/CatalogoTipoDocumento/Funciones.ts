...
export const FNGet = (oidc: IOidc, Id?: number) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.post(`${GetServerUrl()}Prospeccion/TipoDocumento/getDocs`, {}, {
            headers: {
...
export const FNUpdateCapturaObligatoria = (oidc: IOidc, Datos: { TipoDocumentoID: number, CapturaObligatoria: boolean, CatalogoTipoDocumentoID: number }) =>
    new Promise((Resolver: any, Denegar: any) => {
        ...
        axios.post(`${GetServerUrl()}Prospeccion/TipoDocumento/updateCapturaObligatoria`, Datos, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
...
export const FNUpdateConsultaBuro = (oidc: IOidc, Datos: { TipoDocumentoID: number, CapturaObligatoria: boolean, CatalogoTipoDocumentoID: number }) =>
    new Promise((Resolver: any, Denegar: any) => {
        console.log('Datos', Datos);
        axios.post(`${GetServerUrl()}Prospeccion/TipoDocumento/updateConsultaBuro`, Datos, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
...
export const FnGetCatTipoDocumento = (oidc: IOidc, documentoTipo?: number) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.post(`${GetServerUrl()}Prospeccion/TipoDocumento/getByCatTipoDocumento`, { "id": documentoTipo }, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
...
export const FNAdd = (oidc: IOidc, Datos: { CatalogoTipoDocumentoID: number, Orden: number, Activo: boolean }) =>
    new Promise((Resolver: any, Denegar: any) => {
        console.log('Datos', Datos);
        axios.post(`${GetServerUrl()}Prospeccion/TipoDocumento/add`, Datos, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
...
export const FNUpdate = (oidc: IOidc, Datos: { CatalogoTipoDocumentoID: number, Orden: number, Activo: boolean }) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.post(`${GetServerUrl()}Prospeccion/TipoDocumento/update`, Datos, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
