...
export const AsignaAnalistaBuro = (props: CFormType) => {
            ...
            <ModalWin.Body>
                ...
                <Formik
                    ...
                    onSubmit={(values: any) => {
                        ...
                        setLoading(true)
                        Funciones.FNAsignaAnalistaBuro(props.oidc, { ...values, ProspectoID: props.Id, PersonaAnalistaID: values.PersonaAnalistaID })
                            .then((respuesta: any) => {
                                setLoading(false)
