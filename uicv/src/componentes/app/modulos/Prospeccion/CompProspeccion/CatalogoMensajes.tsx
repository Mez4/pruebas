...
import Mensajes from './CatalogoMensajes/Mensajes'
import Procesos from './CatalogoMensajes/Procesos'
import Documentos from './CatalogoMensajes/Documentos'
import Relacion from './CatalogoMensajes/Relacion'

type CatalogosType = {
    oidc: IOidc
}

const CatalogoMensajes = (props: CatalogosType) => {
    ...
    return (
        <div className="row">
            <div className="col-12">
                <Card Title="Mensajes fijos para las Notas">
                    <Card.Body>
                        <Card.Body.Content>
                            <div className='row'>
...
export default connect(mapStateToProps, mapDispatchToProps)(CatalogoMensajes);