...
import { CustomFieldText, Spinner, ActionSelect, ModalWin } from '../../../../../global'
            ...
            <ModalWin.Body>
                ...
                <Formik
                    ...
                    onSubmit={(values: any) => {
                        ...
                        setLoading(true)
                        Funciones.FNAsignaAnalista(props.oidc, { ...values, ProspectoID: props.Id, PersonaAnalistaID: values.PersonaAnalistaID })
                            .then((respuesta: any) => {
                                setLoading(false)
                                props.cbActualizar(respuesta)
                                toast.success("ANALISTA ASIGNADO CORRECTAMENTE")
                                props.fnCancelar()
                            })
                            .catch((error: any) => {
