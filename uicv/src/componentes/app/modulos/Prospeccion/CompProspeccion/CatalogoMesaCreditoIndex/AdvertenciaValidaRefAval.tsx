...
export const AdvertenciaValidaRefAval = (props: FormaNotasTipo) => {
    ...
    const FNValidaRef = (ReferenciaID: number) => {
        ...
        Funciones.FNupdateValidaAvalRef(props.oidc, ReferenciaID)
            .then((respuesta: any) => {
                setLoading(false)
                toast.success('REFERENCIA AVAL VALIDADA CORRECTAMENTE', respuesta)
    ...
    const FNRechazaRef = (ReferenciaID: number, Nota: string) => {
        setState(e=>({...e, Cargando: true}))
        Funciones.FNupdateRechazRefAval(props.oidc, { ReferenciaID, Nota })
            .then((respuesta: any) => {
                setLoading(false)
                toast.success('REFERENCIA AVAL RECHAZADA CORRECTAMENTE', respuesta)
                props.fnCancelaAdvertencia()
                props.fnCerrarInfoAval()
                props.FNGetLocal()
            })
