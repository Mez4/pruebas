...
import * as Funciones from './CatalogoTipoDocumentoAval/Funciones'
...
import { CForm } from './CatalogoTipoDocumentoAval/CForm'
...
const CatalogoTipoDocumentoAval = (props: CatalogosType) => {
    // Controll our mounted state
    let isMounted = React.useRef(true)

    const DatosDefecto = { TipoDocumentoAvalID: 0, CatalogoTipoDocumentoID: 0, Orden: 0, Activo: false }
    const Datos: any[] = []
    ...
    const Columns = React.useMemo(() => {
        ...
        let colRet: IDataTableColumn[] =
            [
                ...
                //                     Datos: { TipoDocumentoAvalID: props.TipoDocumentoAvalID, CatalogoTipoDocumentoID: props.CatalogoTipoDocumentoID, Orden: props.Orden, Activo: props.Activo },
                //                     Id: props.TipoDocumentoAvalID
    ...
    const cbAgregar = (item: any) => {
        setState({ ...state, Datos: [...state.Datos, item], Form: { ...state.Form, Mostrar: false, Datos: { TipoDocumentoAvalID: 0, CatalogoTipoDocumentoID: -1, Orden: 0, Activo: false } } })
    }

    // /** funcion Callback al actualizar un item */
    const cbActualizar = (item: any) =>
        setState({ ...state, Datos: state.Datos.map(Dato => Dato.TipoDocumentoAvalID === item.TipoDocumentoAvalID ? item : Dato), Form: { ...state.Form, Mostrar: false, Datos: { TipoDocumentoAvalID: 0, CatalogoTipoDocumentoID: 0, Orden: 0, Activo: false } } })
    ...
    return (
        <div className="row">
            <div className="col-12">
                <Card Title="Administrar Documentos Solicitados de los Avales">
                    <Card.Body>
                        <Card.Body.Content>
                            ...
                            {!state.Cargando && !state.Error &&
                                <div>
                                    <DataTable
                                        ...
                                        defaultSortField={"TipoDocumentoAvalID"}
                                        columns={Columns}
                                    />
...
export default connect(mapStateToProps, mapDispatchToProps)(CatalogoTipoDocumentoAval);
