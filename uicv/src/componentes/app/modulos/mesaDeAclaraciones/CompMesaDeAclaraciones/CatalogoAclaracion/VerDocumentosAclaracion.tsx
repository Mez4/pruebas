...
const VerDocumentosAclaracion = (props: CatalogosType) => {
    // Controll our mounted state
    let isMounted = React.useRef(true)

    const AclaracionID: number = props.AclaracionID
    ...
    const FNGetLocal = () => {
        ...
        Funciones.FnGetEvidencia(props.oidc, props.AclaracionID, props.DocumentoID)
            .then((respuesta: any) => {
    ...
    //useEffect with conditional change value
    React.useEffect(() => {
        FNGetLocal()
        // eslint-disable-next-line
    }, [props.AclaracionID])
...
export default connect(mapStateToProps, mapDispatchToProps)(VerDocumentosAclaracion);