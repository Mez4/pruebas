...
const CatalogoTipoSolicitud = (props: CatalogosType) => {    // Controll our mounted state
    ...
    const Columns:/*: React.useMemo(() => {
        ...
        [
            { name: 'Id', selector: 'TipoSolicitudID', sortable: true, width: '20%' },
            { name: 'Clave', selector: 'ClaveSolicitud', sortable: true, width: '20%' },
    ...
    return (
        <div className="row">
            <div className="col-12">
                <Card Title="TIPOS DE SOLICITUDES">
                    <Card.Body>
                        <Card.Body.Content>
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="input-group mb-3">
                                                        <input type="text" className="form-control" placeholder="Buscar Solicitudes" value={state.Filtro} onChange={e => setState(s => ({ ...s, Filtro: e.target.value }))} />
                                                        <span className="input-group-text"><FaSearch /> </span>
                                                        <button className="btn btn-outline-secondary" type="button"
                                                            onClick={() => setState({ ...state, Form: { Mostrar: true, Datos: { TipoSolicitudID: 0, ClaveSolicitud: '', Descripcion: '' }, Id: undefined } })}
                                                        ><FaPlus /></button>
...
export default connect(mapStateToProps, mapDispatchToProps)(CatalogoTipoSolicitud);