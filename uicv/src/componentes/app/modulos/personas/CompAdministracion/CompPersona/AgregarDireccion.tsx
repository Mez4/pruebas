...
type AgregarEmpleoType = {
    oidc: IOidc,
    Mostrar: boolean,
    DefinirDirecciones(direcciones: any): any,
    OcultarFormas(): any,
    PersonaID: number
}
export const AgregarDireccion = ({ oidc, Mostrar, DefinirDirecciones, OcultarFormas, PersonaID }: AgregarEmpleoType) => {
    return (
        <ModalWin large={true} open={Mostrar}>
            ...
            <ModalWin.Body>
                <AsistenteFormik
                    ...
                    MostrarPasos={true}
                    Pasos={[
                        FormasGeneral.FormaDireccion({ Titulo: 'Direccion', SubTitulo: 'Dirección personal', Prefijo: 'DireccionPersona_' })
                    ]}
                    ...
                    PROMESA__PROCESAR={(Datos: any) => {
                        ...
                        return Funciones.FNAgregarDireccion(oidc, { ...Datos, PersonaID })
                    }}

                    // LIMPIEZA DE DATOS (O, FUNCIONES AL TERMINAR EL USO DEL CONTROL)
                    FN__LIMPIAR={(Datos: any, DatosPromesa: any) => DefinirDirecciones(DatosPromesa)}
