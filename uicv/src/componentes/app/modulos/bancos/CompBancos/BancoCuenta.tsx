...
import * as Funciones from './BancoCuenta/Funciones'
...
import { CForm } from './BancoCuenta/CForm'
...
const BancoCuenta = (props: CatalogosType) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(BancoCuenta)