...
import * as Funciones from './BancoCuentasMaestras/Funciones'
...
import { CForm } from './BancoCuentasMaestras/CForm'
...
const CatalogoCuentasMaestras = (props: CatalogosType) => {
    ...
    const Columns = React.useMemo(() => {
        let colRet: IDataTableColumn[] =
            [
                { name: 'Id', selector: 'agrupacionID', sortable: true, },
                        ...
                        <button className="asstext" type={"button"} onClick={() => {
                            setState(s => ({
                                ...
                                Form: {
                                    ...s.Form, Mostrar: true,
                                    Datos: {
                                        agrupacionID: props.agrupacionID,
                                        clave: props.clave,
                                        descripcion: props.descripcion,
                                        activo: props.activo,
                                    },
                                    Id: props.agrupacionID
    ...
    return (
        <div className="row">
            <div className="col-12">
                ...
                <Card Title="Catalogo Cuentas Maestras">
                    <Card.Body>
                        <Card.Body.Content>
