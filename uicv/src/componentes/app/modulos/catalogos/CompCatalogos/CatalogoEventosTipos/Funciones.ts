...
export const FNGet = (oidc: IOidc, Id?: number) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.post(`${GetServerUrl()}Catalogos/EventosTipos/get`, {}, {
            headers: {
 ...
 * @returns any
 */
export const FNAdd = (oidc: IOidc, Datos: { eventoTipo: string }) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.post(`${GetServerUrl()}Catalogos/EventosTipos/add`, Datos, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
...
export const FNUpdate = (oidc: IOidc, Datos: { pagareEstatusId: number, pagareEstatusDesc: string }) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.post(`${GetServerUrl()}Catalogos/EventosTipos/update`, Datos, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
