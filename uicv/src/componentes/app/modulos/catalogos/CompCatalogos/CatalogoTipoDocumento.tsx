...
const CatalogoTipoDocumento = (props: CatalogosType) => {
    ...
    const DatosDefecto = { activo: false, claveDoc: '', documentosTipoNombre: '', ordenSistema: 0, soloIMG: false }
    const Datos: any[] = []
    ...
    const cbAgregar = (item: any) => {
        setState({ ...state, Datos: [...state.Datos, item], Form: { ...state.Form, Mostrar: false, Datos: { activo: false, claveDoc: '', documentosTipoNombre: '', ordenSistema: 0, soloIMG: false } } })
    }


    /** funcion Callback al actualizar un item */
    const cbActualizar = (item: any) =>
        setState({ ...state, Datos: state.Datos.map(Dato => Dato.documentosTipoId === item.documentosTipoId ? item : Dato), Form: { ...state.Form, Mostrar: false, Datos: { activo: false, claveDoc: '', documentosTipoNombre: '', ordenSistema: 0, soloIMG: false } } })
                            ...
                            {state.Datos.length > 0 &&
                                <div>
                                    ...
                                    <DataTable
                                        ...
                                        noHeader
                                        responsive
                                        keyField={"documentosTipoId"}
                                        defaultSortField={"documentosTipoId"}
                                        columns={[
                                            {
                                                name: 'Id',
                                                selector: 'documentosTipoId',
                                                sortable: true,
                                            },
                                            {
                                                name: 'Tipo',
                                                selector: 'documentosTipoNombre',
                                                sortable: true,
                                            },
                                            {
                                                name: 'Clave',
                                            ...
                                            },
                                            {
                                                ...
                                                selector: 'soloIMG',
                                                sortable: true,
                                                cell: (props) => <span>{props.soloIMG ? "SI" : "No"}</span>
                                            },
                                            {
                                                name: 'Activo',
                                                selector: 'activo',
