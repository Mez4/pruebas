...
import { CForm } from './CompCatalogoPantallas/CForm'
...
const CatalogoPantallas = (props: CatalogosType) => {
    ...
    const FNGetLocal = async () => {
        ...
        try {
            ...
            const Datos = (await axios.get(`${GetServerUrl()}Sistema/Pantallas`, GenerarCabeceraOIDC(props.oidc))).data
    ...
    const Columns = [
        ...
        { name: 'Id', selector: 'PantallaID', sortable: true },
        ...
        { name: 'Pantalla', selector: 'PantallaNombre', sortable: true },
        {
            ...
            cell: (cprops: DBConfia_Sistema.IPantallas_VW) =>
                <React.Fragment>
    ...
    return (
        <div className="row">
            <div className="col-12">
                <Card Title="PANTALLAS DE APLICACIÓN">
                    <Card.Body>
                        <Card.Body.Content>
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="input-group mb-3">
                                                        <input type="text" className="form-control" placeholder="Buscar pantalla" value={state.Filtro} onChange={e => setState(s => ({ ...s, Filtro: e.target.value }))} />
                                    ...
                                    <ModalWin open={state.MostrarForm}>
                                        <ModalWin.Header>
                                            <h5 className={MODAL_TITLE_CLASS}>
                                                {state.Item ? "Editar Pantalla" : "Agregar Pantalla"}
                                            </h5>
                                        </ModalWin.Header>
                                        <ModalWin.Body>
                                            <CForm
                                                key={"frm__" + state.Item?.PantallaID ?? 0}
                                                oidc={props.oidc}
                                                Pantalla={state.Item}
...
export default connect(mapStateToProps, mapDispatchToProps)(CatalogoPantallas)