...
const CatalogoPantallasExcel = (props: CatalogosType) => {
    ...
    return (
        <div className="row">
            <div className="col-12">
                <Card Title="PANTALLAS EXCEL DE APLICACIÓN">
                    <Card.Body>
                        <Card.Body.Content>
...
export default connect(mapStateToProps, mapDispatchToProps)(CatalogoPantallasExcel)