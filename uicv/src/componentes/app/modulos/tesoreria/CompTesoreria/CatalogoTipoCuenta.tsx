...
import * as Funciones from './CatalogoTipoCuenta/Funciones'
...
import { CForm } from './CatalogoTipoCuenta/CForm'
...
const CatalogoTipoCuenta = (props: CatalogosType) => {
    ...
    const cbActualizar = (item: any) => {
        ...
        setState({ ...state, Datos: state.Datos.map(Dato => Dato.TipoID === item.TipoID ? item : Dato), Form: { ...state.Form, Mostrar: false, Datos: { Descripcion: '' } } })
    ...
    return (
        <div className="row">
            <div className="col-12">
                <Card Title="Administrar Tipos de Cuenta">
                    <Card.Body>
                        <Card.Body.Content>
...
export default connect(mapStateToProps, mapDispatchToProps)(CatalogoTipoCuenta);