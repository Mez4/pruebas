...
export const FNGet = (oidc: IOidc, Id?: number) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.post(`${GetServerUrl()}tesoreria/tipocuenta/get`, {}, {
            headers: {
...
export const FNAdd = (oidc: IOidc, Datos: { Descripcion: string }) =>
    new Promise((Resolver: any, Denegar: any) => {
        ...
        axios.post(`${GetServerUrl()}tesoreria/tipocuenta/add`, Datos, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
...
export const FNUpdate = (oidc: IOidc, Datos: { Descripcion: string }) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.post(`${GetServerUrl()}tesoreria/tipocuenta/update`, Datos, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
