...
import * as Funciones from './AltaSolicitudGastos/Funciones'
...
import { CForm } from './AltaSolicitudGastos/CForm'
...
const AltaSolicitudGastos = (props: CatalogosType) => {
                    ...
                    <button data-tip data-for="TT1" className="asstext" type={"button"} onClick={() => {
                        ...
                        setState(s => ({
                            ...
                            Form: {
                                ...
                                Datos:
                                {
                                    RubroGastosID: props.RubroGastosID,
                                    Clave: props.Clave,
                                    Descripcion: props.Descripcion,
                                    Activo: props.Activo,
                                    RegistraID: props.RegistraID,
                                    AfectaUtilidad: props.AfectaUtilidad,
                                    GastoCorporativo: props.GastoCorporativo,
                                    Cargo: props.Cargo,
                                },
                                Id: props.RubroGastosID
                            }
                        }))
                    }}>
                        <FaPencilAlt />
    ...
    return (
        <div className="row">
            <div className="col-12">
                <Card Title="Alta de Solicitud de Gastos">
                    <Card.Body>
                        <Card.Body.Content>
                            <Formik
...
export default connect(mapStateToProps, mapDispatchToProps)(AltaSolicitudGastos);