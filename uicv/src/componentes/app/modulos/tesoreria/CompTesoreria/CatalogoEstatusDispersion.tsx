...
import * as Funciones from './CatalogoEstatusDispersion/Funciones'
...
import { CForm } from './CatalogoEstatusDispersion/CForm'
...
const CatalogoEstatusDispersion = (props: CatalogosType) => {
    ...
    const Columns = React.useMemo(() => {
        let colRet: IDataTableColumn[] =
            [
                { name: 'Id', selector: 'estatusArchivoID', sortable: true, },
                        ...
                        <button className="asstext" type={"button"} onClick={() => {
                            setState(s => ({
                                ...
                                Form: {
                                    ...s.Form, Mostrar: true,
                                    Datos: {
                                        estatusArchivoID: props.estatusArchivoID,
                                        estatus: props.estatus,
                                        descripcion: props.descripcion
                                    },
                                    Id: props.estatusArchivoID
                                }
                            }))
                        }}>
                            <FaPencilAlt />
    ...
    const cbAgregar = (item: any) => {
        toast.success('El estatus se agrego correctamente')
        FNGetDatos()
        setState(state => ({
    ...
    const cbActualizar = (item: any) => {
        ...
        FNGetDatos()
        setState(state => ({
            ...state, Datos: state.Datos.map(Dato => Dato.estatusArchivoID === item.estatusArchivoID ? item : Dato),
            Form: {
                ...state.Form, Mostrar: false,
                Datos: {
                    estatusArchivoID: 0,
    ...
    return (
        <div className="row">
            <div className="col-12">
                <Card Title="Estatus de archivo de dispersión">
                    <Card.Body>
                        <Card.Body.Content>
                                    ...
                                    <ModalWin large={true} open={state.Form.Mostrar}>
                                        <ModalWin.Header>
                                            <h5 className={MODAL_TITLE_CLASS}>
                                                ...
                                                {state.Form.Id ? "Editar Estatus" : "Agregar Estatus"}
                                            </h5>
                                        </ModalWin.Header>
                                        <ModalWin.Body>
                                            <CForm
...
export default connect(mapStateToProps, mapDispatchToProps)(CatalogoEstatusDispersion)