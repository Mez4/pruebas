...
const VerDocumento2 = (props: CatalogosType) => {
    ...
    const FNGetLocal = () => {
        ...
        Funciones.FNGetDocsByDocumentoID2(props.oidc, props.DocumentoID)
            .then((respuesta: any) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(VerDocumento2);