...
import { DispersarAutomatica } from './CreditosDispersionH2H/DispersionAutomatica'
...
const CreditosDispersion = (props: CatalogosType) => {
                        ...
                        <Card.Body.Content>
                            ...
                            <div>
                                <BuscarCreditos
                                    ...
                                    fnCancelar={() => setState(s => ({ ...s, Form: { MostrarAuto: false, Mostrar: false, Activar: false } }))}
                                    fnMostrarAuto={() => setState(s => ({ ...s, Form: { MostrarAuto: true, Mostrar: false, Activar: true } }))} />
                                ...
                                />}
                                <ModalWin open={state.Form.MostrarAuto} large={false} center={true} >
                                    <ModalWin.Header>
                                        <h5 className={MODAL_TITLE_CLASS}>DISPERSION AUTOMATICA</h5>
                                    </ModalWin.Header>
                                    <ModalWin.Body>
                                        {
                                            <DispersarAutomatica
                                                ...
                                                fnCancelar={() => setState(s => ({ ...s, Form: { MostrarAuto: false, Mostrar: false, Activar: false } }))}
                                                fnMostrarAuto={() => setState(s => ({ ...s, Form: { MostrarAuto: true, Mostrar: false, Activar: true } }))}
                                                fnActivar={() => setState(s => ({ ...s, Form: { Activar: true, Mostrar: false, MostrarAuto: true } }))}
                                                CargandoModaL={false}
                                                Activar={false} />
                                        }
                                    </ModalWin.Body>
...
export default connect(mapStateToProps, mapDispatchToProps)(CreditosDispersion)