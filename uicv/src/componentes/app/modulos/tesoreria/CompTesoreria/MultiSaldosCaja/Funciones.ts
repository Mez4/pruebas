...
export const FNGet = (Seguridad: IOidc) => new Promise((Resolver: any, Denegar: any) => {
    axios.get(`${GetServerUrl()}SOMA/Balance/generar-msaldos-cajas`, {
        headers: {
...
export const FNPrintPDF = (oidc: IOidc, Datos: { MultiSaldoCajaID: number }) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.post(`${GetServerUrl()}SOMA/Balance/imprimir-msaldos-cajas`, Datos, {
            headers: {
                "Content-Type": "application/json",
...
export const FNImprimir = (oidc: IOidc, Datos: {
    ...
    export const FNGetMovimientosTraspasos = async (oidc: IOidc, Datos:any
        ) =>
        new Promise((Resolver: any, Denegar: any) => {
            axios.post(`${GetServerUrl()}SOMA/Balance/getMovimientosTraspasos`, Datos, {
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${oidc.user.access_token}`
                }
