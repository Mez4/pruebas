...
import * as Funciones from "./CreditosTesoreria/Funciones";
...
import { BuscarCreditos } from "./CreditosTesoreria/BuscarCredito";
...
// import FolioConfirmacion from "../../creditos/CompCreditos/FolioConfirmacion/FolioConfirmacion";
...
const CreditosTesoreria = (props: CatalogosType) => {
  ...
  const FNCancelarCredito = (data: any) => {
    ...
    setState(s => ({
        ...
        Form: {
            ...
            Datos: {
                ...
                EmpleadoId: data.ClienteID,
                interes: data.Interes,
                manejo: data.ManejoCuenta,
                iva: data.IVA,
                Motivo: data.Observaciones,
                InteresVG: data.PorcInteres,
                ManejoVG: data.PorcManejoCuenta,
                IvaVG: data.PorcIVA,
                datoBancario: data.datoBancario,
                personasDatosBancariosID: data.personasDatosBancariosID == null ? 0 : data.personasDatosBancariosID,
                RequiereDatosBancarios: data.personasDatosBancariosID != null ? true : false,
                PrestamoPersonal: data.PrestamoPersonal,
                Principal: data.Principal,
                EsNomina: data.EsNomina,
                FechaExpedicion: new Date,
                MvCancelacion: data.MvCancelacion,
                TipoCancelacionID: data.TipoCancelacionID,
                NombreBeneficiario: data.NombreBeneficiario,
                ApellidoPaternoBeneficiario: data.ApellidoPaternoBeneficiario,
                ApellidoMaternoBeneficiario: data.ApellidoMaternoBeneficiario,
                ParentescoBeneficiario: data.ParentescoBeneficiario,
                FechaNacimientoBeneficiario: data.FechaNacimientoBeneficiario
            },
            Id: data.CreditoID
        }
    }))
      ...
      Funciones.updatedCreditoSpeiaEfectivo(props.oidc, {
        ...
        //   setLoading(false);
          if (respuesta.res == 1) {
            ...
            cbUpdateSpeiaEfectivo(CreditoID);
          } else {
  ...
  const Columns = React.useMemo(() => {
    ...
    //   },
      ...
      {
        name: "Estatus Envio STP",
        selector: "EnvioSTPEstatusID",
        sortable: false,
        conditionalCellStyles: filtroStyle(props),
      },
    ];
  ...
  const HiddenColumns: IDataTableColumn[] = [
    {
      ...
      cell: (data) => (
        ...
        >
          ...
          <button
            data-tip
            data-for={`CancelarCreditoTooltip${data.CreditoID}`}
            disabled={data.EstatusID == 'C' || data.EnvioSTPEstatusID == 'D'}
            className="asstext"
            style={{
              margin: ".15em",
              width: "10%",
            ...
            type="button"
            onClick={() => {
                FNCancelarCredito(data);
            }}
          >
            <FaBan />
          </button>
          <ReactTooltip
            id={`CancelarCreditoTooltip${data.CreditoID}`}
            type="info"
            effect="solid"
            clickable
            globalEventOff="click"
          ...
          <button
            data-tip
            data-for={`SPEIEfectivoTooltip${data.CreditoID}`}
            disabled={data.TipoDesembolso != 'SPEI POR STP' || data.EstatusID == 'C' || data.EnvioSTPEstatusID == 'D'}
            className="asstext"
            style={{
              margin: ".15em",
              width: "10%",
          ...
          <ReactTooltip
            id={`SPEIEfectivoTooltip${data.CreditoID}`}
            type="info"
            effect="solid"
            clickable
            globalEventOff="click"
    ...
    // >
      <div className="row">
        <div className="col-12">
          <Card Title="Consulta de Créditos">
            <Card.Body>
              <Card.Body.Content>
...
export default connect(mapStateToProps, mapDispatchToProps)(CreditosTesoreria);
