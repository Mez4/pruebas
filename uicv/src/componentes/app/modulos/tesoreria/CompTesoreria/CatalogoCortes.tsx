...
import * as Funciones from './CatalogoCortes/Funciones'
...
import { CForm } from './CatalogoCortes/CForm'
...
const CatalogoCortes = (props: CatalogosType) => {    // Controll our mounted state
                        ...
                        <button className="asstext" type={"button"} onClick={() => {
                            setState(s => ({
                                ...
                                Form: {
                                    ...
                                    Datos: { CorteID: props.CorteID, Cortes: props.Cortes, Clave: props.Clave },
                                    Id: props.CorteID
                                }
    ...
    const cbAgregar = (item: any) => {
        toast.success('El corte se agregó correctamente')
    ...
    const cbActualizar = (item: any) => {
        setState({ ...state, Datos: state.Datos.map(Dato => Dato.CorteID === item.CorteID ? item : Dato), Form: { ...state.Form, Mostrar: false, Datos: DatosDefecto } })
        toast.success('El corte se actualizó correctamente')
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(CatalogoCortes);