...
export const BuscarCreditosArchivo = (props: CFormType) => {
    console.log("INICIALES ,", props.initialValues)
    ...
    return (
        <Formik
            ...
            onSubmit={(values: any) => {
                ...
                Funciones.FNgetbyfiltrosODP(props.oidc, {
                    ...values,
                            ...
                            <div style={{ display: 'inline-block' }}>
                                <div className="columns is-centered is-mobile is-multiline">
                                    <div className="column is-one-quarter-desktop is-half-tablet is-full-mobile">
                                        <Productos oidc={props.oidc} isSingle disabled={loading} name={'ProductoID'} valor={values.ProductoID} />
                                    </div>
                                    <div className="column is-one-quarter-desktop is-half-tablet is-full-mobile">
