 ...
 * @returns any
 */
export const FNGet = (Seguridad: IOidc, Datos: any) => new Promise((Resolver: any, Denegar: any) => {
    axios.post(`${GetServerUrl()}SOMA/Balance/generar-msaldos-bovedas`, Datos, {
        headers: {
...
export const FNPrintPDF = (oidc: IOidc, Datos: { MultiSaldoID: number }) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.post(`${GetServerUrl()}SOMA/Balance/imprimir-msaldos-bovedas`, Datos, {
            headers: {
                "Content-Type": "application/json",
