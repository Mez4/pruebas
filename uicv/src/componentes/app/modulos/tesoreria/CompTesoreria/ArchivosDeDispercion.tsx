...
const ArchivosDedispersion = (props: CatalogosType) => {
    ...
    return (
        <div className="row">
            <div className="col-12">
                <Card Title="Dispersar créditos por archivo de lotes">
                    <Card.Body>
                        <Card.Body.Content>
                            <div>
                                        ...
                                        <Form>
                                            <div className='row'>
                                                ...
                                                <div className="btn-group" role="group" aria-label="Basic radio toggle button group">
                                                    <Field checked={state.CheckedSTP} type="radio" className="btn-check" name="tipoCliente" id="Cliente1" autoComplete="off" value="1" onClick={() => {
                                                        setState(s => ({ ...s, CheckedSTP: true, CheckedODP: false, TipoDesembolsoID: 12 }));
                                                        console.log("STATE STP,", state.TipoDesembolsoID)
                                                        // FNGetPeriodos("A");
                                                    }} />
                                                    <label className="btn btn-outline-primary" htmlFor="Cliente1">STP</label>

                                                    <Field checked={state.CheckedODP} type="radio" className="btn-check" name="tipoCliente" id="Cliente2" autoComplete="off" value="2" onClick={() => {
                                                        setState(s => ({ ...s, CheckedSTP: false, CheckedODP: true, TipoDesembolsoID: 3 }));

                                                        console.log("STATE ODP,", state.TipoDesembolsoID)
                                                        // FNGetPeriodos("C");
                                                    }} />
                                                    <label className="btn btn-outline-primary" htmlFor="Cliente2">ODP</label>
                                                </div>
                                            </div>
                                        </Form>
                                    </Formik>
...
export default connect(mapStateToProps, mapDispatchToProps)(ArchivosDedispersion)