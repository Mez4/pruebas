...
export const FNGet = (oidc: IOidc, Id?: number) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.get(`${GetServerUrl()}SOMA/SolicitudCortes/obtenerProducto`, {
            headers: {
...
export const FNAdd = (oidc: IOidc, Datos: any) =>
    new Promise((Resolver: any, Denegar: any) => {
        ...
        axios.post(`${GetServerUrl()}SOMA/SolicitudCortes/insertar`, Datos, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
...
export const FNUpdate = (oidc: IOidc, Datos: any) =>
    new Promise((Resolver: any, Denegar: any) => {
        axios.put(`${GetServerUrl()}SOMA/SolicitudCortes/actualizar`, Datos, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${oidc.user.access_token}`
            }
