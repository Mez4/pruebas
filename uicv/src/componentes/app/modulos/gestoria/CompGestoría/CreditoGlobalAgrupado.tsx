...
import { formatDate, addOneDay } from "../../../../../global/functions";
              ...
              const Heading = [
                {
                  ...
                  ventasTotalesTiendita: "ventasTotalesTiendita",
  ...
  return (
    <div className="row">
      <div className="col-12">
        <Card Title="Global Créditosss Gestor">
          <Card.Body>
            <Card.Body.Content>
              <div>
                <FiltroPorUsuario
