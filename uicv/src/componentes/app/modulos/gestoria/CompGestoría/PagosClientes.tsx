...
import FormPagosClientes from "./PagosClientes/FormPagosClientes";
...
function PagosClientes(props: NotasRapidasType) {
    const { Componentes, FnReportes, Modulo, ResponseData, SetInitialValues, FnReporteList, LoadingComps } = useDibujarModuloReporte({ PantallaID: 49 })
        ...
        <div>
            <div className="row">
                <div className="col-12">
                    <Card Title="Pagos Clientes">
                        <Card.Body>
                            <Card.Body.Content>
                                {LoadingComps && <Spinner />}
                                {!LoadingComps && <FormPagosClientes
