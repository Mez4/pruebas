...
import { FiltrarDatos } from "../../../creditos/CompCreditos/CreditoColocacion/Funciones";
...
const AsignarZonales = (props: CatalogosType) => {
  ...
  const Columns = React.useMemo(() => {
    let colRet: IDataTableColumn[] = [
      { name: "ID", selector: "ZonalID", sortable: true, wrap: true },
      {
        name: "Nombre Zonal",
      ...
      },
      {
        ...
        cell: (props) => (
          <span>
            {!props.RegionalID
              ? "SIN ASIGNAR"
              : props.RegionalID + "-" + props.RegionalNombre}
          </span>
        ),
      },
      {
