...
function NotasRapidas(props: NotasRapidasType) {
  const { Componentes, FnReportes, Modulo, ResponseData, SetInitialValues, FnReporteList, LoadingComps } = useDibujarModuloReporte({ PantallaID: 14 })
