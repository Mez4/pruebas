...
import * as Funciones from './CreditoNivelesProducto/Funciones'
...
import { CForm } from './CreditoNivelesProducto/CForm'
...
const CreditoNivelesProducto = (props: CatalogosType) => {
    ...
    const DatosDefecto2 = {
        ...
        monto: 0,
        IncrementoQuincena: 0,
        IncrementoQuincenaCalidadBaja: 0
    ...
    const FNGetLocal2 = () => {
        ...
        Funciones.GetLocal23(props.oidc)
            .then((respuesta: any) => {
                ...
                setState(s => ({ ...s, optEmpresas: productos }))
                // }
            })
            .catch(() => {
                // if (isMounted.current === true) {
                setState(s => ({ ...s, Cargando: false, Error: true, Datos: [], optEmpresas: [] }))
                // }
            })
    }
    ...
    const Columns = React.useMemo(() => {
        let colRet: IDataTableColumn[] =
            [
                ...
                { name: 'Incremento Quincenal', selector: 'IncrementoQuincena', sortable: true, },
                { name: 'Incremento Quincenal Baja', selector: 'IncrementoQuincenaCalidadBaja', sortable: true, },
                {
                            ...
                            setState(s => ({
                                ...
                                Form: {
                                    ...
                                    Datos2: {
                                        ...
                                        monto: props.monto,
                                        IncrementoQuincena: props.IncrementoQuincena,
                                        IncrementoQuincenaCalidadBaja: props.IncrementoQuincenaCalidadBaja
                                    },
                                    Id: props.ProductoID
                                },
                                isUpdate: true
    ...
    const Columns2 = React.useMemo(() => {
        let colRet: IDataTableColumn[] =
            [
                { name: 'Id Producto', selector: 'ProductoID', sortable: true, },
                { name: 'Producto', selector: 'Producto', sortable: true, },
            ]
        return colRet
    }, [])
...
export default connect(mapStateToProps, mapDispatchToProps)(CreditoNivelesProducto)