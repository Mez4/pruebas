...
import FormDistPagoVencimiento from "./CreditosCierreValesDistVencimiento/FormCierreValesDistVencimiento";
...
function CreditoCierreValesDistVencimiento(
    ...
    <div>
      <div className="row">
        <div className="col-12">
          <Card Title="Cierre vales x Distribuidor 162sssss5">
            <Card.Body>
              <Card.Body.Content>
                <FormDistPagoVencimiento
                  oidc={props.oidc}
                  ui={props.ui}
                  initialValues={{
                    DirectorID: 0,
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(CreditoCierreValesDistVencimiento);
