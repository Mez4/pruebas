...
import * as Funciones from "./CreditoTabSaldosPlazos/Funciones";
...
const TabTasasPlazos = (props: CatalogosType) => {
  ...
  const FnSaveTabulador = () => {
    ...
    Funciones.FnGuardarCondicionesCsv(props.oidc, { CondicionesList: JSON.stringify(DatosTabla.current) })
      .then((res: any) => {
  ...
  return (<BodyTemplate title="Tabulador de tasas y plazos" >
    <>
      <div>
        <FilterTemplate>
...
export default connect(mapStateToProps, mapDispatchToProps)(TabTasasPlazos);
