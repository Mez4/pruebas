...
import { CForm } from './CreditoDistribuidor/CForm'
...
const CreditoDistribuidor = (props: CatalogosType) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(CreditoDistribuidor)