            ...
            <Formik
                ...
                onSubmit={(values: any) => {
                    ...
                    if (shopInfo.totalPrice > 0)
                        if (shopInfo.totalPrice <= (props.DatosDistribuidor.Monedero ?? 0)) {
                            setLoading(true);
                            ...
                            Funciones.FNAddVentaContadoMonedero(props.oidc, {
                                ...values,
                            ...
                            toast.error(
                                `El límite de compra en la tiendita es de $${(props.DatosDistribuidor.Monedero ?? 0)}`
                            );
                        }
                    ...
                    <Form>
                        ...
                        <div className="columns is-desktop is-tablet">
                            <div className="column is-two-thirds">
                                ...
                                {shopInfo.totalPrice > (props.DatosDistribuidor.Monedero ?? 0) && (
                                    <div className="text-danger">{`El límite de compra en la tiendita es de $${(props.DatosDistribuidor.Monedero ?? 0).toLocaleString(
                                        "en"
                                    )}`}</div>
                                )}
                            </div>
