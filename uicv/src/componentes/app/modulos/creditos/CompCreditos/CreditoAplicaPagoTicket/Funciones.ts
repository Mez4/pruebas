...
export const FNGetTickets = (
  ...
  new Promise((Resolver: any, Denegar: any) => {
    axios
      .post(`${GetServerUrl()}creditos/AplicaPagos/GetTickets`, Datos, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${oidc.user.access_token}`,
        },
...
export const FNAddPagoTicket = (
  ...
  new Promise((Resolver: any, Denegar: any) => {
    ...
    axios
      .post(`${GetServerUrl()}creditos/AplicaPagos/AddPagoTicket`, Datos, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${oidc.user.access_token}`,
        },
