...
export const CForm = (props: CFormType) => {
  ...
  const cbArticles = (values: any) => {
    console.log("info totaaaaal", values);
    setShowStore(false);
    if (values.cart !== null) {
  ...
  const DescargarPDF = (respuesta: any) => {
    toast.info("Se está generando el documento, por favor espere...");
    Funciones.FNPdfVentaContado(props.oidc, {
      ...
      <Formik
        ...
        onSubmit={(values: any) => {
          if (shopInfo.totalPrice > 0) {
            ...
            Funciones.FNAddVentaContado(props.oidc, {
              ...values,
