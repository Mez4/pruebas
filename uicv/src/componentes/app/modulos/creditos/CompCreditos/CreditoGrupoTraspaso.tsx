...
// Icons
import { FaExclamationCircle, FaPencilAlt, FaPlus, FaSearch } from 'react-icons/fa'
...
const CreditoGrupoTraspaso = (props: CatalogosType) => {
    ...
    }, [props.GrupoID, props.SucursalID]);
    ...
    const FNGetLocal = () => {
        ...
        FnGrupoDetalle.FNGet(props.oidc, props.GrupoID)
            .then((respuesta: any) => {
                // if (isMounted.current === true) {
                // alert('entre')
...
export default connect(mapStateToProps, mapDispatchToProps)(CreditoGrupoTraspaso)