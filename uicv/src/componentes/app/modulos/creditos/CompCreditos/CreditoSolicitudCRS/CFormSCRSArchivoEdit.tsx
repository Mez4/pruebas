...
export const CFormSCRSCArchivoEdit = (props: CFormType) => {
    ...
    const [state, setState] = useState({
        ...
        initialValues: {
            DocumentoID: props.initialValues.DocumentoID,
        TipoDocumentoID: props.initialValues.TipoDocumentoID,
        NombreDocumento: props.initialValues.NombreDocumento,
        Accion: props.initialValues.Accion,
        Ruta: props.initialValues.Ruta,
        Status: props.initialValues.Status,
        Autorizado: props.initialValues.Autorizado,
...
export default CFormSCRSCArchivoEdit;