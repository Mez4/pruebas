...
import { Aplicaciones } from "./AplicacionesClientes/AplicacionesClientes";
...
const AplicacionesClientes = (props: CatalogosType) => {
  ...
  return (
    <div className="row">
      <div className="col-12">
        <Card Title="Aplicaciones clientes">
          <Card.Body>
            <Card.Body.Content>
...
export default connect(mapStateToProps, mapDispatchToProps)(AplicacionesClientes);
