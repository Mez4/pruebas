...
import { CForm } from './CreditoVentaContado/CForm'
...
const CreditoVentaContado = (props: CatalogosType) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(CreditoVentaContado)