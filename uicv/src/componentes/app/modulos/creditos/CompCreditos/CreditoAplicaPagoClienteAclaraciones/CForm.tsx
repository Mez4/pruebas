    ...
    <Formik
      ...
      onSubmit={(values: any) => {
        ...
        Funciones.FNAdd(props.oidc, {
          ...
          MovimientoIDs: props.DNIsSeleccionados.map((x) => x.MovimientoID),
      ...
      {({ values }) => (
        <Form>
          ...
          <div className="columns is-desktop is-tablet">
            ...
            <div className="column is-12-mobile is-12-tablet is-6-desktop">
              <CustomFieldText2
                disabled={values.Liquida || !!props.DNIsSeleccionados.length}
                label={"Importe Pagar"}
                name={"A_Pagar"}
                placeholder={"0"}
              />
          ...
          {!!props.DNIsSeleccionados.length && (
            <DataTable
              subHeader
              subHeaderComponent={<div>DNIs Seleccionados</div>}
              data={props.DNIsSeleccionados}
              striped
              pagination
              dense
              noHeader
