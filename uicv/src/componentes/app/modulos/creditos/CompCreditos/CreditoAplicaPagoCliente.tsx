...
import { CForm } from "./CreditoAplicaPagoCliente/CForm";
...
const CreditoAplicaPagoCliente = (props: CatalogosType) => {
  ...
  const cbActualizaDatos = (
    ...
    if (ClienteID > 0) {
      Funciones.FNGetSaldosCredito(props.oidc, { ClienteID: ClienteID,   CreditoID: CreditoID })
        .then((respuesta: any) => {
      ...
      /*width: '95px',*/ selector: "CreditoID",
        ...
        cell: (props) =>
          props.CreditoID != null ? (
            <span
              style={{ minWidth: "15%", whiteSpace: "nowrap", overflow: "hidden" }}
            >
              {props.CreditoID}
            </span>
          ) : (
