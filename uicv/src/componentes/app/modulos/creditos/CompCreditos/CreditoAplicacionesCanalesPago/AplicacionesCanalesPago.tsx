...
const canalesPagoOptions = [
  { value: 1, label: "BBVA" },
  { value: 2, label: "RPM" },
];

export const AplicacionesCanalesPago = (props: CFormType) => {
  ...
  return (
    <Formik
      ...
      validationSchema={Yup.object().shape({
        ...
        CanalPago: Yup.number().required("Seleccione canal de pago"),
      })}
      onSubmit={(values: any) => {
        setLoading(true);
        Funciones.FNGetAplicacionesCanalesPago(props.oidc, {
          ...values,
                ...
                <div className="columns is-desktop is-tablet">
                  <div className="column is-12-mobile is-12-tablet is-3-desktop">
                    <ActionSelect
                      ...
                      options={canalesPagoOptions}
                      addDefault={false}
                      valor={props.initialValues.CanalPago}
                    />
                  </div>
                </div>
              </div>
