...
export const FNgetbyfiltros = async (
  ...
  new Promise((Resolver: any, Denegar: any) => {
    ...
    axios
      .post(`${GetServerUrl()}creditos/credito_vw/getbyfiltros`, Datos, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${oidc.user.access_token}`,
        },
...
export const FNgetbyfiltrosCancelacion = async (
  ...
  new Promise((Resolver: any, Denegar: any) => {
    ...
    axios
      .post(
        `${GetServerUrl()}creditos/credito_vw/getbyfiltrosCancelacion`,
        Datos,
        {
          headers: {
            "Content-Type": "application/json",
...
export const FNgetbyfiltrosSpei_Efectivo = async (
  oidc: IOidc,
  Datos: {
    CreditoID: number;
    ProductoID: number;
  ...
  new Promise((Resolver: any, Denegar: any) => {
    ...
    axios
      .post(
        `${GetServerUrl()}creditos/credito_vw/getbyfiltrosSPEIaEfectivo`,
        Datos,
        {
          headers: {
            "Content-Type": "application/json",
...
export const FNgetTipoDesembolsoSPEI = async (oidc: IOidc) =>
  new Promise((Resolver: any, Denegar: any) => {
    // console.log('Datos: ', Datos)

    axios
      .get(`${GetServerUrl()}Creditos/credito/getTipoDesembolsoSPEI`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${oidc.user.access_token}`,
        },
...
export const FNDesembolsar = async (
  oidc: IOidc,
  CreditoID: number,
  CajaID: number
) =>
