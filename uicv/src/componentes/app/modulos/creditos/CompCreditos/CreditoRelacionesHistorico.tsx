...
import * as Funciones from './CreditoRelacionesHistorico/Funciones'
...
import { CForm } from './CreditoRelacionesHistorico/CForm'
...
const CreditoRelacionesHistorico = (props: CatalogosType) => {
    ...
    const DatosDefecto = { SucursalID: 0, CoordinadorID: 0, tipo: '1', formato: '1', fecha: '' }
    const Datos: any[] = []
    ...
    const fnGetDistribuidores = (SucursalID: number, CoordinadorID: number, fechaCorte: string) => {
        if (SucursalID > 0 && CoordinadorID > 0)
            FnDistribuidores.FNGetByCoordinadorSucursalHistorico(props.oidc, SucursalID, CoordinadorID, fechaCorte)
                .then((respuesta: any) => {
    ...
    return (
        ...
        <Card Title="Relaciones Histórico">
            <Card.Body>
                <Card.Body.Content>
...
export default connect(mapStateToProps, mapDispatchToProps)(CreditoRelacionesHistorico)