...
import * as Funciones from './CatalogoAnalistasReestructuras/Funciones'
...
const CatalogoAnalistasReestructuras = (props: CatalogosType) => {
    ...
    return (
        <div className="row">
            <div className="col-12">
                <Card Title="Administrar Analistas de Reestructuras">
                    <Card.Body>
                        <Card.Body.Content>
...
export default connect(mapStateToProps, mapDispatchToProps)(CatalogoAnalistasReestructuras);
