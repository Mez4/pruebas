...
export default function FormGlobal(props: FormDistPagoVencimientoType) {
        ...
        const result = await MySwal.fire({
            ...
            html: (
                <div className="text-center">
                    Este reporte está deshabilitado. Para consultar la información de cobranza, por favor utilice el reporte 1625.
                </div>
            ),
