...
import * as Funciones from "./CreditoGlobalNuevo/Funciones";
...
function CreditoGlobalNuevo2(
    ...
    //                 setState((s) => ({ ...s, Datos: respuesta, Cargando: false, Error: false, DatosExcel: Excelit, }));
    //             }
    //         })
    //         .catch(() => {
    //             setState((s) => ({ ...s, Datos: [], Cargando: false, Error: true }));
    //         });
    // };
    const FNGetGlobal = () => {
...
export default connect(mapStateToProps, mapDispatchToProps)(CreditoGlobalNuevo2);
