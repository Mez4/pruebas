...
const CustomPdfImgUpload2 = (props: CustomFieldType) => {
    ...
    return (
        <div className="mb-3 text-center">
            ...
            <button className="form-control" type={"button"} onClick={() => {
                ...
                {' '}
                {values.imageName ? values.imageName : "Seleccionar Archivo"}
            </button>
            <br />
            {values.imageName === '' && <div className="text-danger">Seleccione el archivo a subir</div>}
            {values.imageName !== '' && <iframe title={""} src={values.imageSrc} style={{ width: '100%', height: 300 }} />}
...
export default CustomPdfImgUpload2