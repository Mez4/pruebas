...
const ActionAsyncSelect = forwardRef((props: CustomFieldType, ref) => {
  const Values = {
    selected: 0,
  };
  ...
  const defaultValue = (options: any, value: any) => {
    if (value === 0) return { value: 0, label: props.placeholder };
  ...
  return (
    <div className="mb-3">
      <label className="form-label mb-0" htmlFor={props.name}>
        {props.label}
      </label>
          ...
          <AsyncSelect
            ...
            onChange={(event) => {
              ...
              if (event) {
                ...
                if (props.accion) props.accion(val);
                if (props.accion2) props.accion2(val_label);
                if (props.accion3) props.accion3(val_label);
                // props.accion2 != null ? props.accion2(val_label) : "No seleccionado"
              } else {
                control.form.setFieldValue(props.name, 0);
                setValues((s) => ({
                  ...s,
                  selected: 0,
                }));
                if (props.accion) props.accion(event);
              }
            }}
            onBlur={() => {
            ...
            isClearable
            noOptionsMessage={() =>
              props.noOptionsMessage ? props.noOptionsMessage : "Sin opciones"
            }
...
export default ActionAsyncSelect;
