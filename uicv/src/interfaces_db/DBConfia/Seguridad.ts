export namespace DBConfia_Seguridad {
    ...
    export interface IUsuarios {
        ...
        AccesoAppPromotor?: boolean
      
        AccesoAppPromotoria?: boolean
    ...
    export interface IUsuariosApp_VW {
    ...
    export interface IUsuariosPromotores_VW {
