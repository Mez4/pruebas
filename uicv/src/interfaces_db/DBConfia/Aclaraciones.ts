export namespace DBConfia_Aclaraciones {
    ...
    export interface IAclaracion_VW {
        ...
        FechaFinalizacionSolicitud?: string
      
        TiempoTotalSolicitud?: number
    ...
    export interface ICatalogoBonificaciones {
    ...
    export interface ITiposCodigos {
