...
namespace ConfiaWebApi.Code
{
    public static class Funciones
    {
        ...
        public static string NumeroALetras(this decimal numberAsString, bool addDec)
        {
            string dec;
            ...
            var res = NumeroALetras(Convert.ToDouble(entero)) + (addDec ? dec : "");
        ...
        public static Bitmap Barcode(string codigo, int width, int height)
        {
...
#pragma warning disable CA1416 // Validar la compatibilidad de la plataforma
            Bitmap bm = new(br.Write(codigo), width, height);
#pragma warning restore CA1416 // Validar la compatibilidad de la plataforma
            return bm;
        }
