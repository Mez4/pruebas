...
{
    [TableName("STP.ConsultaOrdenesDetalle_VW")]
    [ExplicitColumns]
    // View, no primary key needed
    public class ConsultaOrdenesDetalle_VW
    {
        ...
        [Column("TipoCuentaBeneficiarioDesc")]
        public string TipoCuentaBeneficiarioDesc { get; set; }
      
        
        [Column("TipoCuentaOrdenanteDesc")]
        public string TipoCuentaOrdenanteDesc { get; set; }
      
        
        [Column("InstitucionContraparteDesc")]
        public string InstitucionContraparteDesc { get; set; }
      
        
        [Column("InstitucionOperanteDesc")]
        public string InstitucionOperanteDesc { get; set; }
