...
{
    [TableName("Creditos.ContratosLineasAdicionalesHistorico")]
    [ExplicitColumns]
    [PrimaryKey("ContratoID,fecha,LineaAdicionalTipoID", AutoIncrement=false)]
    public class ContratosLineasAdicionalesHistorico
    {
        ...
        public async Task<List<DBContext.DBConfia.Seguridad.Usuarios>> CH__SEGURIDAD_USUARIOS085228A6(DBConfiaContext parContext)
        {
            try
            {
