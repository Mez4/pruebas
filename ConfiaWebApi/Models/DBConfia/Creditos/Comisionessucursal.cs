...
{
    [TableName("Creditos.ComisionesSucursal")]
    [ExplicitColumns]
    [PrimaryKey("ProductoID,SucursalId", AutoIncrement=false)]
    public class ComisionesSucursal
    {
        ...
        public async Task<List<DBContext.DBConfia.General.Personas>> CH__PersonaRegistraID(DBConfiaContext parContext)
        {
            try
            {
        ...
        public async Task<List<DBContext.DBConfia.Seguridad.Usuarios>> CH__SEGURIDAD_USUARIOS5887A92E(DBConfiaContext parContext)
        {
            try
            {
        ...
        public async Task<List<DBContext.DBConfia.Seguridad.Usuarios>> CH__SEGURIDAD_USUARIOS7962A69A(DBConfiaContext parContext)
        {
            try
            {
