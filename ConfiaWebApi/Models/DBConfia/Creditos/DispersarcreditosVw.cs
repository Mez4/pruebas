...
{
    [TableName("Creditos.DispersarCreditos_VW")]
    [ExplicitColumns]
    // View, no primary key needed
    public class DispersarCreditos_VW
    {
        ...
        [Column("MinutosDiferencia")]
        public int? MinutosDiferencia { get; set; }
        ...
        [Column("FechaRegistroDato")]
        public DateTime? FechaRegistroDato { get; set; }
