    ...
    public class GlobalController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetbyFiltros(PeticionesRest.Creditos.GlobalVW.Get parData)
        {
            ...
            try
            {
                ...
                {
                    case 4:
                        var Grupos = await ConexionBD.database.QueryAsync<Global>("EXEC Gestoria.pa_GenerarGlobalGestor_sel @DirectorID, @ProductoID, @ZonaID, @SucursalID, @GrupoID, @DistribuidorID, @ClienteID, @UsuarioID, @Tipo, @tipoDias", parData).ToArrayAsync();
                        parData.Tipo = 5;
                        var Distribuidores = await ConexionBD.database.QueryAsync<Global>("EXEC Gestoria.pa_GenerarGlobalGestor_sel @DirectorID, @ProductoID, @ZonaID, @SucursalID, @GrupoID, @DistribuidorID, @ClienteID, @UsuarioID, @Tipo, @tipoDias", parData).ToArrayAsync();
                    ...
                    default:
                        ...
                        var res = await ConexionBD.database.QueryAsync<Global>("EXEC Gestoria.pa_GenerarGlobalGestor_sel @DirectorID, @ProductoID, @ZonaID, @SucursalID, @GrupoID, @DistribuidorID, @ClienteID, @UsuarioID, @Tipo, @tipoDias", parData).ToArrayAsync();
        ...
        public async Task<IActionResult> getdataGlobal(PeticionesRest.Creditos.GlobalVW.Get parData)
        {
            ...
            try
            {
                ...
                var res = await ConexionBD.database.QueryAsync<GlobalExp_VW>("Where UsuarioID=@0", UsuarioActual.UsuarioID).ToArrayAsync();
