...
namespace ConfiaWebApi.Controllers.Sistema
{
    ...
    public class PantallasExcelController : ControllerBase
    {
        /// <summary>
        ...
        public PantallasExcelController(DBConfiaContext _ConexionBD, IConfiguration _Configuration)
        {
        ...
        public async Task<IActionResult> Obtener()
        {
            ...
            {
                // Obtenemos los usuarios
                var resultado = await ConexionBD.database.QueryAsync<dynamic>("").ToArrayAsync();
